...
SPEC = [
    ...
    ('certificate signatory name', 14, True, False),
    ('certificate "Academic Head"', 14, False, False),
    ('certificate "ISSM Business School"', 12, False, False),
    ('examiner labels', 12, True, False),
